...
var sfmcPushProfileDataObj = require('app_custom_sfmc/cartridge/scripts/service/sfmcPushProfileDataAPI');
                            ...
                            if (!authenticatedCustomer) {
								...
								var result = sfmcTokenServiceObj.call(requestBody);
								 if (result.status === 'OK') {
									...
									newCustomerProfile.custom.sfmcToken = sfmcToken;
								}

                                //SFMC PUSH PROFILE API
                                //sfcc calls the update profile api of sfmc on customer registeration after token is generated.
                                var profileRequestBody = {};
                                profileRequestBody.ContactKey =  newCustomerProfile.email;
								profileRequestBody.EventDefinitionKey = 'APIEvent-6672fda5-87a3-6c8e-9343-efb144638a54';
                                profileRequestBody.Data = {  
                                            "CustomerID" : newCustomerProfile.email,
                                            "CustomerRegistered" : newCustomerProfile.getCustomer().isAuthenticated(),
                                            "CustomerNo" : newCustomerProfile.customerNo,
                                            "Email" : newCustomerProfile.email,
                                            "FirstName" : newCustomerProfile.firstName,
                                            "SecondName" : newCustomerProfile.lastName
                                } 
                                sfmcPushProfileDataObj.call(profileRequestBody,sfmcToken);
                            }
                        });
                    } catch (e) {
                        if (e.authError) {
